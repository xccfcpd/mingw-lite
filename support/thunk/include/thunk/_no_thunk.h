...
#define __DECLARE_NON_THUNK_FUNCTION(module, name)                             \
  ...
  namespace
  {
    ...
    __DECLARE_NON_THUNK_FUNCTION(ntdll, NtQueryInformationThread)
    __DECLARE_NON_THUNK_FUNCTION(ntdll, NtQuerySystemInformation)
...
#define __DECLARE_MS_IMPORT(name)                                              \
  ...
  __DECLARE_MS_IMPORT(NtQueryInformationThread)
  __DECLARE_MS_IMPORT(NtQuerySystemInformation)
